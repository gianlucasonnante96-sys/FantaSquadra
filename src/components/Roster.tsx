    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-black p-4 md:p-8 pt-20">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-slate-900/60 backdrop-blur-md rounded-2xl border border-white/10 p-4 mb-6 relative z-40">
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 bg-slate-800/80 border border-slate-700/50 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-emerald-500/60 focus:ring-2 focus:ring-emerald-500/20 transition-all"
            />
        ...
        {localRoster.length === 0 && (
          <div className="bg-slate-900/60 backdrop-blur-md rounded-2xl border border-white/10 p-8 mb-6 text-center">
        ...
        <div className="space-y-4">
          {(['P', 'D', 'C', 'A'] as Role[])
            ...
            .map(role => {
              ...
              return (
                <div key={role} className="bg-slate-900/60 backdrop-blur-md rounded-2xl border border-white/10 overflow-hidden">
                  <div className={`px-4 py-3 bg-gradient-to-r ${roleLabels[role].color} bg-opacity-10 border-b border-white/10`}>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                        {players.map(player => {
                          ...
                          return (
                            <div
                              key={player.id}
                              className="flex items-center justify-between p-3 bg-slate-800/40 hover:bg-slate-800/60 rounded-xl transition-all border border-white/5 hover:border-emerald-500/30"
                            >
        ...
        {/* Status */}
        <div className="mt-6 bg-slate-900/60 backdrop-blur-md rounded-2xl border border-white/10 p-4">
          ...
          <button
            ...
            className={`w-full py-4 font-black rounded-xl transition-all text-sm tracking-wide uppercase ${
              hasMinimumPlayers
                ? 'bg-gradient-to-r from-emerald-400 to-green-600 text-black hover:scale-[1.02] shadow-lg shadow-emerald-500/50'
